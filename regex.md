...
-   `pgrep`
    ...
    -   GNU
        ...
        -   Not maintained by the FSF GNU project.

            Linux distributions seem to ship with a GPL v2 licensed version as part of [procps-ng/procps](https://gitlab.com/procps-ng/procps/).

            > `man 1 pgrep`

            -   > pgrep \[option ...\] _pattern_
            -   > pkill \[option ...\] _pattern_
            -   > pidwait \[option ...\] _pattern_
            -   > -f, --full
                >
